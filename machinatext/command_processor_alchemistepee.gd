...
func process_command(input: String) -> String:
	if input.contains("coeur") or input.contains("pureté") or input.contains("pûreté") or input.contains("quoi") or input.contains("penses"):
		return "Il ne comprendra donc jamais que l'épée ne lui accordera point son accord. Il suffirait pourtant qu'il daigne l'écouter pour le comprendre."
	else:
		return "Cette situation m'éxaspère ..."
